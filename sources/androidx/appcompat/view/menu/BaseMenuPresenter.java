...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    /* renamed from: a */
    private MenuPresenter.Callback f831a;
    ...
    public MenuView.ItemView createItemView(ViewGroup viewGroup) {
        return (MenuView.ItemView) this.mSystemInflater.inflate(this.f833c, viewGroup, false);
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            MenuView menuView = (MenuView) this.mSystemInflater.inflate(this.f832b, viewGroup, false);
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
        MenuPresenter.Callback callback = this.f831a;
        if (callback != null) {
    ...
    public boolean onSubMenuSelected(androidx.appcompat.view.menu.SubMenuBuilder r2) {
        /*
            r1 = this;
            androidx.appcompat.view.menu.MenuPresenter$Callback r0 = r1.f831a
