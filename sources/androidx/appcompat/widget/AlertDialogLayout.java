...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: f */
    private void m800f(int i, int i2) {
    ...
    /* renamed from: q */
    private void m801q(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: r */
    private static int m802r(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m802r(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: s */
    private boolean m803s(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0131R.C0133id.topPanel) {
                    view = childAt;
                } else if (id == C0131R.C0133id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0131R.C0133id.contentPanel && id != C0131R.C0133id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
