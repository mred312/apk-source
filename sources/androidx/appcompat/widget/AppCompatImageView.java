...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    /* renamed from: a */
    private final C0317b f1210a;

    /* renamed from: b */
    private final AppCompatImageHelper f1211b;
    ...
    public void drawableStateChanged() {
        ...
        C0317b bVar = this.f1210a;
        if (bVar != null) {
            bVar.mo2943b();
        }
        AppCompatImageHelper appCompatImageHelper = this.f1211b;
    ...
    public boolean hasOverlappingRendering() {
        return this.f1211b.mo2239e() && super.hasOverlappingRendering();
    }
    ...
    public AppCompatImageView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f1211b = appCompatImageHelper;
