...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView {
    ...
    /* renamed from: a */
    private final C0318c f1215a;

    /* renamed from: b */
    private final C0317b f1216b;

    /* renamed from: c */
    private final C0324i f1217c;
    ...
    public void drawableStateChanged() {
        ...
        C0317b bVar = this.f1216b;
        if (bVar != null) {
            bVar.mo2943b();
        }
        C0324i iVar = this.f1217c;
        if (iVar != null) {
            iVar.mo2971b();
        }
    }
    ...
    public AppCompatRadioButton(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0131R.attr.radioButtonStyle);
    }
