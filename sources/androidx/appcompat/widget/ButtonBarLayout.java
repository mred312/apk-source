...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        int[] iArr = C0131R.styleable.ButtonBarLayout;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        this.f1255a = obtainStyledAttributes.getBoolean(C0131R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0131R.C0133id.spacer);
    ...
    public int getMinimumHeight() {
        return Math.max(this.f1257c, super.getMinimumHeight());
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i4 = 0;
        if (this.f1255a) {
            if (size > this.f1256b && m851b()) {
                setStacked(false);
            }
            this.f1256b = size;
        }
        if (m851b() || View.MeasureSpec.getMode(i) != 1073741824) {
            i3 = i;
            z = false;
        } else {
