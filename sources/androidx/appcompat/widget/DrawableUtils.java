...
public class DrawableUtils {
    ...
    /* renamed from: a */
    private static final int[] f1266a = {16842912};

    /* renamed from: b */
    private static final int[] f1267b = new int[0];

    /* renamed from: c */
    private static Class<?> f1268c;

    static {
        if (Build.VERSION.SDK_INT >= 18) {
            try {
                f1268c = Class.forName("android.graphics.Insets");
    ...
    /* renamed from: a */
    static void m852a(@NonNull Drawable drawable) {
    ...
    /* renamed from: b */
    private static void m853b(Drawable drawable) {
        int[] state = drawable.getState();
        if (state == null || state.length == 0) {
            drawable.setState(f1266a);
        } else {
            drawable.setState(f1267b);
        }
    ...
    public static Rect getOpticalBounds(Drawable drawable) {
        ...
        if (f1268c != null) {
            try {
                ...
                if (invoke != null) {
                    Rect rect2 = new Rect();
                    for (Field field : f1268c.getFields()) {
