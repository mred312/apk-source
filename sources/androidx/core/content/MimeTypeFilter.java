...
public final class MimeTypeFilter {
    ...
    /* renamed from: a */
    private static boolean m1483a(@NonNull String[] strArr, @NonNull String[] strArr2) {
        if (strArr2.length != 2) {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return m1483a(str.split("/"), str2.split("/"));
    }
