...
public final class PaintCompat {
    ...
    /* renamed from: a */
    private static final ThreadLocal<Pair<Rect, Rect>> f2318a = new ThreadLocal<>();

    private PaintCompat() {
    }

    /* renamed from: a */
    private static Pair<Rect, Rect> m1531a() {
        ThreadLocal<Pair<Rect, Rect>> threadLocal = f2318a;
    ...
    public static boolean hasGlyph(@NonNull Paint paint, @NonNull String str) {
        ...
        Pair<Rect, Rect> a = m1531a();
        paint.getTextBounds("󟿽", 0, 2, (Rect) a.first);
    ...
    public static boolean setBlendMode(@androidx.annotation.NonNull android.graphics.Paint r4, @androidx.annotation.Nullable androidx.core.graphics.BlendModeCompat r5) {
        /*
            ...
            android.graphics.BlendMode r2 = androidx.core.graphics.C0453a.m1549a(r5)
        L_0x000e:
            r4.setBlendMode(r2)
            return r1
        L_0x0012:
            if (r5 == 0) goto L_0x0027
            android.graphics.PorterDuff$Mode r5 = androidx.core.graphics.C0453a.m1550b(r5)
