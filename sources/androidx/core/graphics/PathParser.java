...
public class PathParser {
    ...
    /* renamed from: a */
    private static void m1532a(ArrayList<PathDataNode> arrayList, char c, float[] fArr) {
        arrayList.add(new PathDataNode(c, fArr));
    }

    /* renamed from: b */
    static float[] m1533b(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    private static void m1534c(java.lang.String r8, int r9, androidx.core.graphics.PathParser.C0452a r10) {
        /*
            r0 = 0
            r10.f2320b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.PathParser.m1534c(java.lang.String, int, androidx.core.graphics.PathParser$a):void");
    }
    ...
    public static PathDataNode[] createNodesFromPathData(String str) {
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m1532a(arrayList, trim.charAt(0), m1535d(trim));
            }
            i2 = e;
            i = e + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m1532a(arrayList, str.charAt(i2), new float[0]);
        }
    ...
    /* renamed from: d */
    private static float[] m1535d(String str) {
        if (str.charAt(0) == 'z' || str.charAt(0) == 'Z') {
            return new float[0];
        }
        try {
            float[] fArr = new float[str.length()];
            C0452a aVar = new C0452a();
            ...
            while (i < length) {
                ...
                i = aVar.f2320b ? i3 : i3 + 1;
            }
            return m1533b(fArr, 0, i2);
    ...
    /* renamed from: e */
    private static int m1536e(String str, int i) {
        while (i < str.length()) {
    ...
    public static class PathDataNode {
        ...
        /* renamed from: a */
        private static void m1537a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            int i2;
            float f;
            float f2;
            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        int i45 = i3 + 6;
                        i2 = i3;
                        m1539c(path, f17, f18, fArr3[i44] + f17, fArr3[i45] + f18, fArr3[i3 + 0], fArr3[i3 + 1], fArr3[i3 + 2], fArr3[i3 + 3] != 0.0f, fArr3[i3 + 4] != 0.0f);
                        f = f17 + fArr3[i44];
                        f2 = f18 + fArr3[i45];
                    }
                    i3 = i2 + i;
                    ...
                    int i46 = i2 + 5;
                    int i47 = i2 + 6;
                    m1539c(path, f17, f18, fArr3[i46], fArr3[i47], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                    f = fArr3[i46];
                    f2 = fArr3[i47];
                }
                f14 = f18;
        ...
        /* renamed from: b */
        private static void m1538b(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: c */
        private static void m1539c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            float f8 = f;
            float f9 = f3;
            ...
            if (d26 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                ...
                m1539c(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            Double.isNaN(d12);
            double d30 = d * d12;
            m1538b(path, (d29 * cos) - (d30 * d24), (d29 * d24) + (d30 * cos), d17, d12, d5, d11, radians, atan2, atan22);
        }
        ...
        public static void nodesToPath(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            char c = 'm';
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                m1537a(path, fArr, c, pathDataNodeArr[i].mType, pathDataNodeArr[i].mParams);
        ...
        PathDataNode(PathDataNode pathDataNode) {
            this.mType = pathDataNode.mType;
            float[] fArr = pathDataNode.mParams;
            this.mParams = PathParser.m1533b(fArr, 0, fArr.length);
        }
    }
}
