...
public abstract class GnssStatusCompat {
    ...
    public static GnssStatusCompat wrap(@NonNull GnssStatus gnssStatus) {
        return new C0480a(gnssStatus);
    }

    @FloatRange(from = 0.0d, mo761to = 360.0d)
