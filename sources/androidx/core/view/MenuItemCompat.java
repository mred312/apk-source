...
public final class MenuItemCompat {
    ...
    class C0531a implements MenuItem.OnActionExpandListener {

        /* renamed from: a */
        final /* synthetic */ OnActionExpandListener f2633a;

        C0531a(OnActionExpandListener onActionExpandListener) {
            this.f2633a = onActionExpandListener;
        }

        public boolean onMenuItemActionCollapse(MenuItem menuItem) {
            return this.f2633a.onMenuItemActionCollapse(menuItem);
        }

        public boolean onMenuItemActionExpand(MenuItem menuItem) {
            return this.f2633a.onMenuItemActionExpand(menuItem);
        }
    }
    ...
    public static MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
        return menuItem.setOnActionExpandListener(new C0531a(onActionExpandListener));
    }
