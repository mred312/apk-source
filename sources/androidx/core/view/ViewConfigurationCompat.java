...
public final class ViewConfigurationCompat {
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f2672a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    /* renamed from: a */
    private static float m1805a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f2672a) != null) {
            try {
    ...
    public static float getScaledHorizontalScrollFactor(@NonNull ViewConfiguration viewConfiguration, @NonNull Context context) {
        ...
        return m1805a(viewConfiguration, context);
    }
