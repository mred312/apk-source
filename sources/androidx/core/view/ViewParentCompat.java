...
public final class ViewParentCompat {
    ...
    /* renamed from: a */
    private static int[] f2673a;

    private ViewParentCompat() {
    }

    /* renamed from: a */
    private static int[] m1806a() {
        int[] iArr = f2673a;
        if (iArr == null) {
            f2673a = new int[2];
        } else {
    ...
    public static void onNestedScroll(ViewParent viewParent, View view, int i, int i2, int i3, int i4) {
        onNestedScroll(viewParent, view, i, i2, i3, i4, 0, m1806a());
    }
    ...
    public static void onNestedScroll(ViewParent viewParent, View view, int i, int i2, int i3, int i4, int i5) {
        onNestedScroll(viewParent, view, i, i2, i3, i4, i5, m1806a());
    }
