...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public LinearSmoothScroller(Context context) {
        this.f4077i = calculateSpeedPerPixel(context.getResources().getDisplayMetrics());
    }

    /* renamed from: c */
    private int m2999c(int i, int i2) {
        int i3 = i - i2;
        if (i * i3 <= 0) {
            return 0;
        }
    ...
    public int calculateTimeForScrolling(int i) {
        return (int) Math.ceil((double) (((float) Math.abs(i)) * this.f4077i));
    }
    ...
    public void onSeekTargetStep(int i, int i2, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        this.mInterimTargetDx = m2999c(this.mInterimTargetDx, i);
        int c = m2999c(this.mInterimTargetDy, i2);
