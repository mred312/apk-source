...
public class DatabaseConfiguration {
    ...
    /* renamed from: a */
    private final Set<Integer> f4478a;
    ...
    public boolean isMigrationRequired(int i, int i2) {
        Set<Integer> set;
        if ((!(i > i2) || !this.allowDestructiveMigrationOnDowngrade) && this.requireMigration && ((set = this.f4478a) == null || !set.contains(Integer.valueOf(i)))) {
            return true;
        }
        return false;
    }
