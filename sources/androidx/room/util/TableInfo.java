...
public class TableInfo {
    ...
    public static class Column {
        ...
        public Column(String str, String str2, boolean z, int i) {
            ...
            this.affinity = m3628a(str2);
        }

        @ColumnInfo.SQLiteTypeAffinity
        /* renamed from: a */
        private static int m3628a(@Nullable String str) {
            if (str == null) {
                return 5;
            }
    ...
    static class C0989a implements Comparable<C0989a> {
        ...
        C0989a(int i, int i2, String str, String str2) {
            this.f4606a = i;
            this.f4607b = i2;
            this.f4608c = str;
            this.f4609d = str2;
        ...
        /* renamed from: a */
        public int compareTo(@NonNull C0989a aVar) {
            int i = this.f4606a - aVar.f4606a;
            return i == 0 ? this.f4607b - aVar.f4607b : i;
        }
    }
    ...
    /* renamed from: a */
    private static Map<String, Column> m3623a(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
    ...
    /* renamed from: b */
    private static List<C0989a> m3624b(Cursor cursor) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            arrayList.add(new C0989a(cursor.getInt(columnIndex), cursor.getInt(columnIndex2), cursor.getString(columnIndex3), cursor.getString(columnIndex4)));
        }
    ...
    /* renamed from: c */
    private static Set<ForeignKey> m3625c(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (query.getInt(columnIndex2) == 0) {
                    ...
                    for (C0989a next : b) {
                        if (next.f4606a == i2) {
                            arrayList.add(next.f4608c);
                            arrayList2.add(next.f4609d);
                        }
                    }
    ...
    @Nullable
    /* renamed from: d */
    private static Index m3626d(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
    ...
    @Nullable
    /* renamed from: e */
    private static Set<Index> m3627e(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
                ...
                if (columnIndex3 != -1) {
                    ...
                    while (query.moveToNext()) {
                        if ("c".equals(query.getString(columnIndex2))) {
                            ...
                            Index d = m3626d(supportSQLiteDatabase, string, z);
                            if (d == null) {
                                query.close();
                                return null;
                            }
    ...
    public static TableInfo read(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        return new TableInfo(str, m3623a(supportSQLiteDatabase, str), m3625c(supportSQLiteDatabase, str), m3627e(supportSQLiteDatabase, str));
    }
