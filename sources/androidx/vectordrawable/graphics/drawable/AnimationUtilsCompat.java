...
public class AnimationUtilsCompat {
    ...
    /* renamed from: a */
    private static Interpolator m3739a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
    ...
    public static Interpolator loadInterpolator(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m3739a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
