...
public class AnimatorInflaterCompat {
    ...
    private static class C1038a implements TypeEvaluator<PathParser.PathDataNode[]> {

        /* renamed from: a */
        private PathParser.PathDataNode[] f4786a;
        ...
        public PathParser.PathDataNode[] evaluate(float f, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            if (PathParser.canMorph(pathDataNodeArr, pathDataNodeArr2)) {
                if (!PathParser.canMorph(this.f4786a, pathDataNodeArr)) {
                    this.f4786a = PathParser.deepCopyNodes(pathDataNodeArr);
                }
                for (int i = 0; i < pathDataNodeArr.length; i++) {
                    this.f4786a[i].interpolatePathDataNode(pathDataNodeArr[i], pathDataNodeArr2[i], f);
                }
                return this.f4786a;
            }
    ...
    /* renamed from: a */
    private static Animator m3740a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f) {
        return m3741b(context, resources, theme, xmlPullParser, Xml.asAttributeSet(xmlPullParser), (AnimatorSet) null, 0, f);
    }

    /* JADX WARNING: Removed duplicated region for block: B:30:0x00b8  */
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.Animator m3741b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        /*
            r8 = r19
            r9 = r20
            r10 = r21
        ...
        L_0x0023:
            ...
            r4 = r25
            r5 = r21
            android.animation.ObjectAnimator r0 = m3750k(r0, r1, r2, r3, r4, r5)
        L_0x003f:
            r3 = r18
            goto L_0x00b2
        L_0x0043:
            ...
            r5 = r25
            r6 = r21
            android.animation.ValueAnimator r0 = m3748i(r0, r1, r2, r3, r4, r5, r6)
            goto L_0x003f
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.C1048a.f4865h
            r7 = r22
            ...
            r6 = r16
            r7 = r25
            m3741b(r0, r1, r2, r3, r4, r5, r6, r7)
            r17.recycle()
            r3 = r18
            r0 = r15
            goto L_0x00b2
        L_0x0093:
            ...
            r3 = r18
            android.animation.PropertyValuesHolder[] r1 = m3752m(r3, r8, r9, r10, r1)
        ...
        L_0x0106:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.m3741b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }

    /* renamed from: c */
    private static Keyframe m3742c(Keyframe keyframe, float f) {
    ...
    /* renamed from: d */
    private static void m3743d(Keyframe[] keyframeArr, float f, int i, int i2) {
    ...
    /* renamed from: e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.PropertyValuesHolder m3744e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        /*
        ...
        L_0x0020:
            ...
            boolean r12 = m3747h(r0)
            if (r12 != 0) goto L_0x0034
        L_0x002c:
            if (r5 == 0) goto L_0x0036
            boolean r12 = m3747h(r4)
        ...
        L_0x0054:
            ...
            androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat$a r0 = new androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat$a
            r0.<init>()
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.m3744e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }

    /* renamed from: f */
    private static int m3745f(TypedArray typedArray, int i, int i2) {
    ...
    /* renamed from: g */
    private static int m3746g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1048a.f4867j);
        int i = 0;
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, "value", 0);
        if ((peekNamedValue != null) && m3747h(peekNamedValue.type)) {
            i = 3;
        }
    ...
    /* renamed from: h */
    private static boolean m3747h(int i) {
        return i >= 28 && i <= 31;
    }

    /* renamed from: i */
    private static ValueAnimator m3748i(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1048a.f4864g);
        TypedArray obtainAttributes2 = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1048a.f4868k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        m3753n(valueAnimator, obtainAttributes, obtainAttributes2, f, xmlPullParser);
    ...
    /* renamed from: j */
    private static Keyframe m3749j(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        Keyframe keyframe;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1048a.f4867j);
        ...
        if (i == 4) {
            i = (!z || !m3747h(peekNamedValue.type)) ? 0 : 3;
        }
        if (z) {
            if (i == 0) {
    ...
    /* renamed from: k */
    private static ObjectAnimator m3750k(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, float f, XmlPullParser xmlPullParser) {
        ObjectAnimator objectAnimator = new ObjectAnimator();
        m3748i(context, resources, theme, attributeSet, objectAnimator, f, xmlPullParser);
    ...
    /* renamed from: l */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.PropertyValuesHolder m3751l(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) {
        /*
            r0 = 0
            r1 = r0
        L_0x0002:
            ...
            int r14 = m3746g(r10, r11, r14, r12)
        L_0x0023:
            ...
            r6 = r14
            r7 = r12
            android.animation.Keyframe r2 = m3749j(r2, r3, r4, r5, r6, r7)
        ...
        L_0x006a:
            int r0 = r1.size()
            android.animation.Keyframe r12 = m3742c(r12, r2)
            r1.add(r0, r12)
            int r9 = r9 + 1
        L_0x0077:
            ...
            goto L_0x0090
        L_0x0087:
            android.animation.Keyframe r11 = m3742c(r11, r4)
            r1.add(r10, r11)
            int r9 = r9 + 1
        L_0x0090:
        ...
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.m3751l(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }
    ...
    /* renamed from: m */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.PropertyValuesHolder[] m3752m(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        /*
            r6 = r20
            r7 = 0
            r8 = r7
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.C1048a.f4866i
            r11 = r18
            r12 = r19
            r13 = r21
            ...
            r4 = r15
            r16 = r5
            android.animation.PropertyValuesHolder r0 = m3751l(r0, r1, r2, r3, r4, r5)
            if (r0 != 0) goto L_0x0052
            r1 = r16
            android.animation.PropertyValuesHolder r0 = m3744e(r14, r1, r9, r10, r15)
        L_0x0052:
        ...
        L_0x0082:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.m3752m(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }

    /* renamed from: n */
    private static void m3753n(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        ...
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "valueFrom") && TypedArrayUtils.hasAttribute(xmlPullParser, "valueTo")) {
            if (namedInt3 == 4) {
                namedInt3 = m3745f(typedArray, 5, 6);
            }
            PropertyValuesHolder e = m3744e(typedArray, namedInt3, 5, 6, "");
            if (e != null) {
        ...
        if (typedArray2 != null) {
            m3754o(valueAnimator, typedArray2, namedInt3, f, xmlPullParser);
        }
    }

    /* renamed from: o */
    private static void m3754o(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        if (namedString != null) {
            ...
            m3755p(PathParser.createPathFromPathData(namedString), objectAnimator, f * 0.5f, namedString2, namedString3);
            return;
        }
    ...
    /* renamed from: p */
    private static void m3755p(Path path, ObjectAnimator objectAnimator, float f, String str, String str2) {
    ...
    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, @AnimatorRes int i, float f) {
        ...
        try {
            ...
            Animator a = m3740a(context, resources, theme, animation, f);
            if (animation != null) {
                animation.close();
            }
            return a;
