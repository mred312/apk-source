...
public class WorkTypeConverters {
    ...
    /* renamed from: androidx.work.impl.model.WorkTypeConverters$a */
    static /* synthetic */ class C1124a {
        ...
        /* renamed from: c */
        static final /* synthetic */ int[] f5304c;
        ...
        static {
            ...
            L_0x004f:
                int[] r5 = f5303b     // Catch:{ NoSuchFieldError -> 0x0059 }
            ...
            L_0x006a:
                int[] r1 = f5302a     // Catch:{ NoSuchFieldError -> 0x0074 }
            ...
            L_0x0074:
                int[] r0 = f5302a     // Catch:{ NoSuchFieldError -> 0x007e }
            ...
            L_0x007e:
                int[] r0 = f5302a     // Catch:{ NoSuchFieldError -> 0x0088 }
            ...
            L_0x0088:
                int[] r0 = f5302a     // Catch:{ NoSuchFieldError -> 0x0092 }
            ...
            L_0x0092:
                int[] r0 = f5302a     // Catch:{ NoSuchFieldError -> 0x009d }
            ...
            L_0x009d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C1124a.<clinit>():void");
        }
    }
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C1124a.f5303b[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C1124a.f5304c[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C1124a.f5302a[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
