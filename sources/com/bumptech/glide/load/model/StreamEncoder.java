...
public class StreamEncoder implements Encoder<InputStream> {
    ...
    /* renamed from: a */
    private final ArrayPool f6064a;

    public StreamEncoder(ArrayPool arrayPool) {
        this.f6064a = arrayPool;
    }
    ...
    public boolean encode(@androidx.annotation.NonNull java.io.InputStream r5, @androidx.annotation.NonNull java.io.File r6, @androidx.annotation.NonNull com.bumptech.glide.load.Options r7) {
        /*
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r0 = r4.f6064a
        ...
        L_0x0042:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r4.f6064a
            r5.put(r0)
            return r1
        L_0x0048:
        ...
        L_0x004d:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r4.f6064a
            r6.put(r0)
            goto L_0x0054
        L_0x0053:
            throw r5
