...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    /* renamed from: a */
    private final ArrayPool f6111a;

    public BitmapEncoder(@NonNull ArrayPool arrayPool) {
        this.f6111a = arrayPool;
    }

    /* renamed from: a */
    private Bitmap.CompressFormat m4498a(Bitmap bitmap, Options options) {
    ...
    public boolean encode(@androidx.annotation.NonNull com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r9, @androidx.annotation.NonNull java.io.File r10, @androidx.annotation.NonNull com.bumptech.glide.load.Options r11) {
        /*
            ...
            android.graphics.Bitmap$CompressFormat r1 = r8.m4498a(r9, r11)
            int r2 = r9.getWidth()
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r10 = r8.f6111a     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r8.f6111a     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
