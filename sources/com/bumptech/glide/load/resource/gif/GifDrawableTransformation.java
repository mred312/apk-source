...
public class GifDrawableTransformation implements Transformation<GifDrawable> {
    ...
    /* renamed from: a */
    private final Transformation<Bitmap> f6214a;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GifDrawableTransformation) {
            return this.f6214a.equals(((GifDrawableTransformation) obj).f6214a);
        }
        return false;
    }
    ...
    public Resource<GifDrawable> transform(@NonNull Context context, @NonNull Resource<GifDrawable> resource, int i, int i2) {
        ...
        Resource<Bitmap> transform = this.f6214a.transform(context, bitmapResource, i, i2);
        if (!bitmapResource.equals(transform)) {
            bitmapResource.recycle();
        }
        gifDrawable.setFrameTransformation(this.f6214a, transform.get());
        return resource;
    }
