...
@Keep
public abstract class NativeAdBase implements C1484Ad {
    ...
    @Keep
    public interface NativeAdLoadConfigBuilder extends C1484Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface NativeLoadAdConfig extends C1484Ad.LoadAdConfig {
    }
