...
public class DexLoadErrorReporter {
    ...
    /* renamed from: a */
    private static final AtomicBoolean f6917a = new AtomicBoolean();

    /* renamed from: com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter$a */
    class C1492a extends Thread {
        ...
        C1492a(Context context, String str) {
            this.f6918a = context;
            this.f6919b = str;
        }
        ...
        public void run() {
            /*
                ...
                android.content.Context r12 = r1.f6918a     // Catch:{ all -> 0x015a }
                com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.m4959b(r12, r11, r10)     // Catch:{ all -> 0x015a }
                ...
                java.lang.String r14 = r1.f6919b     // Catch:{ all -> 0x015a }
                r12.put(r13, r14)     // Catch:{ all -> 0x015a }
                ...
                android.content.Context r2 = r1.f6918a     // Catch:{ all -> 0x0158 }
                com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.m4959b(r2, r12, r10)     // Catch:{ all -> 0x0158 }
            ...
            L_0x01a7:
                goto L_0x01a6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.C1492a.run():void");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m4959b(Context context, JSONObject jSONObject, String str) {
        String packageName = context.getPackageName();
        jSONObject.put("APPBUILD", context.getPackageManager().getPackageInfo(packageName, 0).versionCode);
        jSONObject.put("APPNAME", context.getPackageManager().getApplicationLabel(context.getPackageManager().getApplicationInfo(packageName, 0)));
        jSONObject.put("APPVERS", context.getPackageManager().getPackageInfo(packageName, 0).versionName);
        jSONObject.put("OSVERS", Build.VERSION.RELEASE);
        jSONObject.put("SDK", AbstractSpiCall.ANDROID_CLIENT_TYPE);
    ...
    public static void reportDexLoadingIssue(Context context, String str, double d) {
        AtomicBoolean atomicBoolean = f6917a;
        if (!atomicBoolean.get() && Math.random() < d) {
            atomicBoolean.set(true);
            new C1492a(context, str).start();
        }
    }
}
