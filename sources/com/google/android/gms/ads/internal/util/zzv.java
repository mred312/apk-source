    ...
    public final String getDefaultUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(zzyy.zzefk)) {
            if (ClientLibraryUtils.isPackageSide()) {
                str = (String) zzbu.zza(context, new zzbw(zzyy, context));
            } else {
                str = (String) zzbu.zza(context, new zzbv(zzyy, GooglePlayServicesUtilLight.getRemoteContext(context), context));
            }
            zzyy.zzefk = str;
        }
        return zzyy.zzefk;
