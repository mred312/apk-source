...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    /* compiled from: com.google.android.gms:play-services-basement@@17.3.0 */
    private abstract class C1677a extends zzc<Boolean> {

        /* renamed from: d */
        private final int f7511d;

        /* renamed from: e */
        private final Bundle f7512e;

        @BinderThread
        protected C1677a(int i, Bundle bundle) {
            super(Boolean.TRUE);
            this.f7511d = i;
            this.f7512e = bundle;
        }
        ...
        public final /* synthetic */ void zza(java.lang.Object r5) {
            ...
            L_0x000c:
                ...
                com.google.android.gms.common.internal.BaseGmsClient r5 = com.google.android.gms.common.internal.BaseGmsClient.this
                r5.zza((int) r0, null)
                android.os.Bundle r5 = r4.f7512e
            ...
            L_0x0076:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.BaseGmsClient.C1677a.zza(java.lang.Object):void");
        }
    ...
    /* compiled from: com.google.android.gms:play-services-basement@@17.3.0 */
    final class C1678b extends zzi {
        public C1678b(Looper looper) {
            super(looper);
        }

        /* renamed from: a */
        private static void m5277a(Message message) {
        ...
        /* renamed from: b */
        private static boolean m5278b(Message message) {
            int i = message.what;
            return i == 2 || i == 1 || i == 7;
        }
        ...
        public final void handleMessage(android.os.Message r8) {
            ...
            L_0x010c:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.BaseGmsClient.C1678b.handleMessage(android.os.Message):void");
        }
    }
    ...
    protected abstract class zzc<TListener> {
        ...
        /* renamed from: a */
        private TListener f7515a;

        /* renamed from: b */
        private boolean f7516b = false;

        public zzc(TListener tlistener) {
            this.f7515a = tlistener;
        }
    ...
    public final class zzd implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (BaseGmsClient.this.zzq) {
                ...
                if (iBinder == null) {
                    ...
                    if (queryLocalInterface == null || !(queryLocalInterface instanceof IGmsServiceBroker)) {
                        iGmsServiceBroker = new IGmsServiceBroker.Stub.C1679a(iBinder);
                    } else {
            ...
            BaseGmsClient.this.zza(0, (Bundle) null, this.f7518a);
        }
        ...
        public final void onServiceDisconnected(ComponentName componentName) {
            ...
            handler.sendMessage(handler.obtainMessage(6, this.f7518a, 1));
        }
    }
    ...
    public static final class zze extends IGmsCallbacks.zza {
        ...
        /* renamed from: a */
        private BaseGmsClient f7520a;

        /* renamed from: b */
        private final int f7521b;

        public zze(@NonNull BaseGmsClient baseGmsClient, int i) {
            this.f7520a = baseGmsClient;
            this.f7521b = i;
        }

        @BinderThread
        public final void onPostInitComplete(int i, @NonNull IBinder iBinder, @Nullable Bundle bundle) {
            Preconditions.checkNotNull(this.f7520a, "onPostInitComplete can be called only once per call to getRemoteService");
            this.f7520a.onPostInitHandler(i, iBinder, bundle, this.f7521b);
            this.f7520a = null;
        }
        ...
        public final void zza(int i, @NonNull IBinder iBinder, @NonNull zzc zzc) {
            Preconditions.checkNotNull(this.f7520a, "onPostInitCompleteWithConnectionInfo can be called only once per call togetRemoteService");
            Preconditions.checkNotNull(zzc);
            this.f7520a.zza(zzc);
            onPostInitComplete(i, iBinder, zzc.f7573a);
        }
    }
    ...
    public void getRemoteService(IAccountAccessor iAccountAccessor, Set<Scope> set) {
        ...
        getServiceRequest.f7531d = this.zzl.getPackageName();
        getServiceRequest.f7534g = getServiceRequestExtraArgs;
        if (set != null) {
            getServiceRequest.f7533f = (Scope[]) set.toArray(new Scope[set.size()]);
        }
        if (requiresSignIn()) {
            getServiceRequest.f7535h = getAccount() != null ? getAccount() : new Account(DEFAULT_ACCOUNT, AccountType.GOOGLE);
            if (iAccountAccessor != null) {
                getServiceRequest.f7532e = iAccountAccessor.asBinder();
            }
        } else if (requiresAccount()) {
            getServiceRequest.f7535h = getAccount();
        }
        getServiceRequest.f7536i = zzd;
        getServiceRequest.f7537j = getApiFeatures();
        try {
            synchronized (this.zzq) {
    ...
    /* compiled from: com.google.android.gms:play-services-basement@@17.3.0 */
    protected final class zzf extends C1677a {

        /* renamed from: g */
        private final IBinder f7522g;
        ...
        public final boolean zza() {
            try {
                String interfaceDescriptor = this.f7522g.getInterfaceDescriptor();
                ...
                IInterface createServiceInterface = BaseGmsClient.this.createServiceInterface(this.f7522g);
            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    if (!(this.zzu == null || (zzk3 = this.zzk) == null)) {
                        String a = zzk3.mo13024a();
                        String b = this.zzk.mo13025b();
                        ...
                        sb.append(b);
                        Log.e("GmsClient", sb.toString());
                        this.zzn.zza(this.zzk.mo13024a(), this.zzk.mo13025b(), this.zzk.mo13026c(), this.zzu, zza(), this.zzk.mo13027d());
                    ...
                    this.zzk = zzk2;
                    if (!zzk2.mo13027d() || getMinApkVersion() >= 17895000) {
                        if (!this.zzn.zza(new GmsClientSupervisor.zza(this.zzk.mo13024a(), this.zzk.mo13025b(), this.zzk.mo13026c(), this.zzk.mo13027d()), this.zzu, zza())) {
                            String a2 = this.zzk.mo13024a();
                            String b2 = this.zzk.mo13025b();
                        ...
                        String valueOf = String.valueOf(this.zzk.mo13024a());
    ...
    /* compiled from: com.google.android.gms:play-services-basement@@17.3.0 */
    protected final class zzg extends C1677a {
        @BinderThread
