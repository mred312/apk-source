...
public class LibraryVersion {
    ...
    /* renamed from: b */
    private static final GmsLogger f7552b = new GmsLogger("LibraryVersion", "");

    /* renamed from: c */
    private static LibraryVersion f7553c = new LibraryVersion();

    /* renamed from: a */
    private ConcurrentHashMap<String, String> f7554a = new ConcurrentHashMap<>();
    ...
    public java.lang.String getVersion(@androidx.annotation.NonNull java.lang.String r10) {
        /*
            ...
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.String> r2 = r9.f7554a
            boolean r2 = r2.containsKey(r10)
            if (r2 == 0) goto L_0x001a
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.String> r0 = r9.f7554a
        ...
        L_0x001a:
            ...
            com.google.android.gms.common.internal.GmsLogger r2 = f7552b     // Catch:{ IOException -> 0x008c, all -> 0x0089 }
            ...
            r2.mo12974v(r1, r5)     // Catch:{ IOException -> 0x008c, all -> 0x0089 }
            goto L_0x0083
        L_0x006a:
            com.google.android.gms.common.internal.GmsLogger r2 = f7552b     // Catch:{ IOException -> 0x008c, all -> 0x0089 }
            java.lang.String r5 = java.lang.String.valueOf(r10)     // Catch:{ IOException -> 0x008c, all -> 0x0089 }
        ...
        L_0x0080:
            r2.mo12976w(r1, r5)     // Catch:{ IOException -> 0x008c, all -> 0x0089 }
        L_0x0083:
        ...
        L_0x0093:
            ...
            r4 = r3
        L_0x0095:
            com.google.android.gms.common.internal.GmsLogger r5 = f7552b     // Catch:{ all -> 0x0091 }
        ...
        L_0x00a6:
            ...
            r0 = r6
        L_0x00ac:
            r5.mo12968e(r1, r0, r2)     // Catch:{ all -> 0x0091 }
        ...
        L_0x00b5:
            ...
            com.google.android.gms.common.internal.GmsLogger r0 = f7552b
