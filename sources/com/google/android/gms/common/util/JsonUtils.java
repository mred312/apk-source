...
public final class JsonUtils {
    ...
    /* renamed from: a */
    private static final Pattern f7625a = Pattern.compile("\\\\.");

    /* renamed from: b */
    private static final Pattern f7626b = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
    ...
    public static String escapeString(@Nullable String str) {
        ...
        Matcher matcher = f7626b.matcher(str);
    ...
    public static String unescapeString(String str) {
        ...
        String zza = zzd.zza(str);
        Matcher matcher = f7625a.matcher(zza);
        StringBuffer stringBuffer = null;
        while (matcher.find()) {
            if (stringBuffer == null) {
                stringBuffer = new StringBuffer();
