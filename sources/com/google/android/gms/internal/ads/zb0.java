...
final class zb0 extends wb0 {
    ...
    public final int mo13671a(int r12, byte[] r13, int r14, int r15) {
        /*
            r11 = this;
            r0 = -19
            r1 = -62
        ...
        L_0x0023:
            ...
            int r12 = com.google.android.gms.internal.ads.vb0.m7077b(r8, r14)
            return r12
        L_0x0036:
            r10 = r14
            r14 = r12
        ...
        L_0x004a:
            ...
            int r12 = com.google.android.gms.internal.ads.vb0.m7077b(r8, r9)
            return r12
        L_0x005b:
            r14 = r12
            r12 = 0
        ...
        L_0x0061:
            ...
            int r12 = com.google.android.gms.internal.ads.vb0.m7083h(r8, r9, r14)
            return r12
        L_0x006e:
            r10 = r14
            r14 = r12
        ...
        L_0x00a8:
            ...
            int r12 = com.google.android.gms.internal.ads.vb0.m7086k(r13, r12, r15)
            return r12
        L_0x00b3:
            int r8 = r12 + 1
            byte r12 = r13[r12]
        ...
        L_0x00ed:
            ...
            goto L_0x0091
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zb0.mo13671a(int, byte[], int, int):int");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final int mo13672b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char charAt;
            ...
            while (r13 < i3) {
                ...
                if (xb0.m7222i(b2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        xb0.m7217d(b3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (xb0.m7223j(b2)) {
                    if (i6 < i3) {
                        xb0.m7216c(b2, bArr[i6], cArr, i5);
                        r13 = i6 + 1;
                        i5++;
                    } else {
                        throw zzeks.m8836i();
                    }
                } else if (xb0.m7224k(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        xb0.m7215b(b2, bArr[i6], bArr[i8], cArr, i5);
                        r13 = i8 + 1;
                        i5++;
                    } else {
                        throw zzeks.m8836i();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    xb0.m7214a(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    r13 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzeks.m8836i();
