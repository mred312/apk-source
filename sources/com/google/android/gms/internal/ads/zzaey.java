...
public final class zzaey extends NativeAppInstallAd {
    ...
    /* renamed from: a */
    private final zzaex f12429a;

    /* renamed from: b */
    private final List<NativeAd.Image> f12430b = new ArrayList();

    /* renamed from: c */
    private final zzaek f12431c;

    /* renamed from: d */
    private final VideoController f12432d = new VideoController();

    /* renamed from: e */
    private final NativeAd.AdChoicesInfo f12433e;

    /* JADX WARNING: Removed duplicated region for block: B:31:0x0074 A[Catch:{ RemoteException -> 0x0081 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public zzaey(com.google.android.gms.internal.ads.zzaex r6) {
        /*
            r5 = this;
            java.lang.String r0 = ""
            r5.<init>()
        ...
        L_0x0046:
            ...
            java.util.List<com.google.android.gms.ads.formats.NativeAd$Image> r2 = r5.f12430b     // Catch:{ RemoteException -> 0x0053 }
        ...
        L_0x0057:
            com.google.android.gms.internal.ads.zzaex r6 = r5.f12429a     // Catch:{ RemoteException -> 0x0065 }
            com.google.android.gms.internal.ads.zzaej r6 = r6.zzsw()     // Catch:{ RemoteException -> 0x0065 }
        ...
        L_0x006a:
            r5.f12431c = r2
            com.google.android.gms.internal.ads.zzaex r6 = r5.f12429a     // Catch:{ RemoteException -> 0x0081 }
            ...
            com.google.android.gms.internal.ads.zzaex r2 = r5.f12429a     // Catch:{ RemoteException -> 0x0081 }
    ...
    public final CharSequence getCallToAction() {
        try {
            return this.f12429a.getCallToAction();
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return null;
        }
    ...
    public final CharSequence getHeadline() {
        try {
            return this.f12429a.getHeadline();
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return null;
        }
    ...
    public final CharSequence getMediationAdapterClassName() {
        try {
            return this.f12429a.getMediationAdapterClassName();
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return null;
        }
    ...
    public final Double getStarRating() {
        try {
            double starRating = this.f12429a.getStarRating();
            if (starRating == -1.0d) {
                return null;
            }
    ...
    public final VideoController getVideoController() {
        try {
            if (this.f12429a.getVideoController() != null) {
                this.f12432d.zza(this.f12429a.getVideoController());
            }
        } catch (RemoteException e) {
    ...
    public final void performClick(Bundle bundle) {
        try {
            this.f12429a.performClick(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
        }
    }
    ...
    public final boolean recordImpression(Bundle bundle) {
        try {
            return this.f12429a.recordImpression(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return false;
        }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        try {
            this.f12429a.reportTouchEvent(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
        }
    }
