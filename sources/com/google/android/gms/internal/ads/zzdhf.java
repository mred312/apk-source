...
public final class zzdhf implements zzdfj<JSONObject> {
    ...
    /* renamed from: a */
    private final Location f15624a;
    ...
    public final /* synthetic */ void zzs(Object obj) {
        ...
        try {
            if (this.f15624a != null) {
                ...
                Float valueOf = Float.valueOf(this.f15624a.getAccuracy() * 1000.0f);
                Long valueOf2 = Long.valueOf(this.f15624a.getTime() * 1000);
                Long valueOf3 = Long.valueOf((long) (this.f15624a.getLatitude() * 1.0E7d));
                Long valueOf4 = Long.valueOf((long) (this.f15624a.getLongitude() * 1.0E7d));
