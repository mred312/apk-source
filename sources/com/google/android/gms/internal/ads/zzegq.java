...
public final class zzegq implements zzdzt {
    ...
    /* renamed from: b */
    private static final ThreadLocal<Cipher> f16152b = new r70();

    /* renamed from: a */
    private final SecretKey f16153a;

    public zzegq(byte[] bArr) {
        zzeic.zzft(bArr.length);
        this.f16153a = new SecretKeySpec(bArr, "AES");
    }

    /* renamed from: a */
    private static AlgorithmParameterSpec m8771a(byte[] bArr, int i, int i2) {
        try {
    ...
    public final byte[] zzc(byte[] bArr, byte[] bArr2) {
        if (bArr.length <= 2147483619) {
            ...
            AlgorithmParameterSpec a = m8771a(zzfs, 0, zzfs.length);
            ThreadLocal<Cipher> threadLocal = f16152b;
            threadLocal.get().init(1, this.f16153a, a);
