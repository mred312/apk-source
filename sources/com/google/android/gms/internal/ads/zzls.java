...
public final class zzls {
    ...
    /* renamed from: b */
    private final MediaCodecInfo.CodecCapabilities f16670b;
    ...
    @TargetApi(21)
    /* renamed from: a */
    private static boolean m9013a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
    ...
    /* renamed from: b */
    private final void m9014b(String str) {
        String str2 = this.name;
        String str3 = this.f16669a;
    ...
    public final boolean zzaw(int i) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.f16670b;
        if (codecCapabilities == null) {
            m9014b("sampleRate.caps");
            return false;
        }
        MediaCodecInfo.AudioCapabilities audioCapabilities = codecCapabilities.getAudioCapabilities();
        if (audioCapabilities == null) {
            m9014b("sampleRate.aCaps");
            return false;
    ...
    public final boolean zzax(int i) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.f16670b;
        if (codecCapabilities == null) {
            m9014b("channelCount.caps");
            return false;
        }
        MediaCodecInfo.AudioCapabilities audioCapabilities = codecCapabilities.getAudioCapabilities();
        if (audioCapabilities == null) {
            m9014b("channelCount.aCaps");
            return false;
    ...
    public final boolean zzaz(java.lang.String r12) {
        /*
            ...
            java.lang.String r1 = r11.f16669a
        ...
        L_0x00c4:
            ...
            return r0
        L_0x00c7:
            java.lang.String r2 = r11.f16669a
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final android.media.MediaCodecInfo.CodecProfileLevel[] zzhc() {
        /*
            r1 = this;
            android.media.MediaCodecInfo$CodecCapabilities r0 = r1.f16670b
        ...
        L_0x000a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzls.zzhc():android.media.MediaCodecInfo$CodecProfileLevel[]");
    }
    ...
    public final boolean zza(int i, int i2, double d) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.f16670b;
        if (codecCapabilities == null) {
            m9014b("sizeAndRate.caps");
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
            m9014b("sizeAndRate.vCaps");
            return false;
        } else if (m9013a(videoCapabilities, i, i2, d)) {
            return true;
        } else {
            if (i >= i2 || !m9013a(videoCapabilities, i2, i, d)) {
