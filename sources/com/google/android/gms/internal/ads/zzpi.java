...
public final class zzpi {
    ...
    /* renamed from: a */
    private static final float[] f16824a = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};

    /* renamed from: b */
    private static final Object f16825b = new Object();

    /* renamed from: c */
    private static int[] f16826c = new int[10];
        ...
        synchronized (f16825b) {
            ...
            while (i3 < i) {
                ...
                if (i3 < i) {
                    int[] iArr = f16826c;
                    if (iArr.length <= i4) {
                        f16826c = Arrays.copyOf(iArr, iArr.length << 1);
                    }
                    f16826c[i4] = i3;
                    i3 += 3;
                    i4++;
