...
import com.google.android.gms.ads.C1655R;

/* compiled from: com.google.android.gms:play-services-ads-lite@@19.5.0 */
public final class zzvy {

    /* renamed from: a */
    private final AdSize[] f17087a;

    /* renamed from: b */
    private final String f17088b;

    public zzvy(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1655R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C1655R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C1655R.styleable.AdsAttrs_adSizes);
        boolean z = !TextUtils.isEmpty(string);
        boolean z2 = !TextUtils.isEmpty(string2);
        if (z && !z2) {
            this.f17087a = m9261a(string);
        } else if (!z && z2) {
            this.f17087a = m9261a(string2);
        } else if (z) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        String string3 = obtainAttributes.getString(C1655R.styleable.AdsAttrs_adUnitId);
        this.f17088b = string3;
    ...
    /* renamed from: a */
    private static AdSize[] m9261a(String str) {
        int i;
        int i2;
