...
public class zzcp {
    ...
    /* renamed from: a */
    private static final Uri f17601a = Uri.parse("content://com.google.android.gsf.gservices/prefix");
    /* access modifiers changed from: private */

    /* renamed from: b */
    public static final AtomicBoolean f17602b = new AtomicBoolean();

    /* renamed from: c */
    private static HashMap<String, String> f17603c;

    /* renamed from: d */
    private static final HashMap<String, Boolean> f17604d = new HashMap<>();

    /* renamed from: e */
    private static final HashMap<String, Integer> f17605e = new HashMap<>();

    /* renamed from: f */
    private static final HashMap<String, Long> f17606f = new HashMap<>();

    /* renamed from: g */
    private static final HashMap<String, Float> f17607g = new HashMap<>();

    /* renamed from: h */
    private static Object f17608h;

    /* renamed from: i */
    private static boolean f17609i;

    /* renamed from: j */
    private static String[] f17610j = new String[0];
    ...
    /* renamed from: a */
    private static Map<String, String> m10296a(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(f17601a, (String[]) null, (String) null, strArr, (String) null);
    ...
    /* renamed from: c */
    private static void m10298c(Object obj, String str, String str2) {
        synchronized (zzcp.class) {
            if (obj == f17608h) {
                f17603c.put(str, str2);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x00c9, code lost:
        m10298c(r0, r11, (java.lang.String) null);
     */
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = f17603c     // Catch:{ all -> 0x00f2 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = f17602b     // Catch:{ all -> 0x00f2 }
            r0.set(r2)     // Catch:{ all -> 0x00f2 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            f17603c = r0     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            f17608h = r0     // Catch:{ all -> 0x00f2 }
            f17609i = r2     // Catch:{ all -> 0x00f2 }
            android.net.Uri r0 = zza     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.measurement.w0 r4 = new com.google.android.gms.internal.measurement.w0     // Catch:{ all -> 0x00f2 }
        ...
        L_0x002a:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = f17604d     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = f17605e     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = f17606f     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = f17607g     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            f17608h = r0     // Catch:{ all -> 0x00f2 }
            f17609i = r2     // Catch:{ all -> 0x00f2 }
        L_0x0054:
            java.lang.Object r0 = f17608h     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = f17603c     // Catch:{ all -> 0x00f2 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f2 }
            if (r4 == 0) goto L_0x006b
            java.util.HashMap<java.lang.String, java.lang.String> r10 = f17603c     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0069:
            ...
            return r3
        L_0x006b:
            java.lang.String[] r4 = f17610j     // Catch:{ all -> 0x00f2 }
        ...
        L_0x006f:
            ...
            boolean r0 = f17609i     // Catch:{ all -> 0x00f2 }
            if (r0 == 0) goto L_0x0085
            java.util.HashMap<java.lang.String, java.lang.String> r0 = f17603c     // Catch:{ all -> 0x00f2 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f2 }
            if (r0 == 0) goto L_0x00a7
        L_0x0085:
            java.lang.String[] r0 = f17610j     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = f17603c     // Catch:{ all -> 0x00f2 }
            java.util.Map r10 = m10296a(r10, r0)     // Catch:{ all -> 0x00f2 }
            r2.putAll(r10)     // Catch:{ all -> 0x00f2 }
            f17609i = r1     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r10 = f17603c     // Catch:{ all -> 0x00f2 }
        ...
        L_0x00c3:
            ...
            m10298c(r0, r11, r3)     // Catch:{ all -> 0x00eb }
        ...
        L_0x00d2:
            ...
            r12 = r3
        L_0x00df:
            m10298c(r0, r11, r12)     // Catch:{ all -> 0x00eb }
