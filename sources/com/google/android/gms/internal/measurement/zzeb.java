...
public final class zzeb {
    /* renamed from: a */
    private static String m10325a(int i, int i2, @NullableDecl String str) {
        if (i < 0) {
    ...
    public static int zzb(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException(m10325a(i, i2, FirebaseAnalytics.Param.INDEX));
    }
    ...
    public static void zza(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                str = m10325a(i, i3, "start index");
            } else if (i2 < 0 || i2 > i3) {
                str = m10325a(i2, i3, "end index");
            } else {
