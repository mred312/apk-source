...
final class C3069o5 implements Application.ActivityLifecycleCallbacks {

    /* renamed from: a */
    private final /* synthetic */ zzgy f18282a;

    private C3069o5(zzgy zzgy) {
        this.f18282a = zzgy;
    }
    ...
    public final void m10626b(boolean r18, android.net.Uri r19, java.lang.String r20, java.lang.String r21) {
        /*
            r17 = this;
            r1 = r17
            r0 = r20
            r2 = r21
            com.google.android.gms.measurement.internal.zzgy r3 = r1.f18282a
            r3.zzc()
            com.google.android.gms.measurement.internal.zzgy r3 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x008c:
            ...
            android.os.Bundle r3 = r3.mo20567f(r11)     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x009b:
            ...
            com.google.android.gms.measurement.internal.zzgy r14 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.zzkw r14 = r14.zzo()     // Catch:{ Exception -> 0x01d6 }
            r15 = r19
            android.os.Bundle r14 = r14.mo20567f(r15)     // Catch:{ Exception -> 0x01d6 }
            if (r14 == 0) goto L_0x00ff
            java.lang.String r15 = "intent"
            r14.putString(r6, r15)     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.zzgy r6 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x00e3:
            ...
            com.google.android.gms.measurement.internal.zzgy r6 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.zzp r6 = r6.f18648l     // Catch:{ Exception -> 0x01d6 }
            r6.mo20597b(r0, r14)     // Catch:{ Exception -> 0x01d6 }
            goto L_0x00ff
        L_0x00fe:
            r14 = 0
        L_0x00ff:
        ...
        L_0x013f:
            ...
            com.google.android.gms.measurement.internal.zzgy r2 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
            ...
            com.google.android.gms.measurement.internal.zzgy r2 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.zzp r2 = r2.f18648l     // Catch:{ Exception -> 0x01d6 }
            r2.mo20597b(r0, r3)     // Catch:{ Exception -> 0x01d6 }
            goto L_0x018a
        L_0x017b:
            com.google.android.gms.measurement.internal.zzgy r0 = r1.f18282a     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x01d6:
            r0 = move-exception
            com.google.android.gms.measurement.internal.zzgy r2 = r1.f18282a
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C3069o5.m10626b(boolean, android.net.Uri, java.lang.String, java.lang.String):void");
    }

    public final void onActivityCreated(Activity activity, Bundle bundle) {
        try {
            this.f18282a.zzq().zzw().zza("onActivityCreated");
            ...
            if (intent != null) {
                ...
                if (data != null) {
                    if (data.isHierarchical()) {
                        this.f18282a.zzo();
                        this.f18282a.zzp().zza((Runnable) new C3060n5(this, bundle == null, data, zzkw.m11006s(intent) ? "gs" : "auto", data.getQueryParameter("referrer")));
                        this.f18282a.zzh().zza(activity, bundle);
                        return;
                    }
                }
                this.f18282a.zzh().zza(activity, bundle);
            ...
            this.f18282a.zzq().zze().zza("Throwable caught in onActivityCreated", e);
        } finally {
            this.f18282a.zzh().zza(activity, bundle);
        }
    }
    ...
    public final void onActivityDestroyed(Activity activity) {
        this.f18282a.zzh().zzc(activity);
    }

    @MainThread
    public final void onActivityPaused(Activity activity) {
        this.f18282a.zzh().zzb(activity);
        zzju zzj = this.f18282a.zzj();
        zzj.zzp().zza((Runnable) new C2958c7(zzj, zzj.zzl().elapsedRealtime()));
    }

    @MainThread
    public final void onActivityResumed(Activity activity) {
        zzju zzj = this.f18282a.zzj();
        zzj.zzp().zza((Runnable) new C2968d7(zzj, zzj.zzl().elapsedRealtime()));
        this.f18282a.zzh().zza(activity);
    }

    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        this.f18282a.zzh().zzb(activity, bundle);
    }
    ...
    /* synthetic */ C3069o5(zzgy zzgy, C3104s4 s4Var) {
        this(zzgy);
    }
}
