...
public final class zzn extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "true", mo13011id = 9)
    public final boolean zzh;
    @SafeParcelable.Field(mo13011id = 10)
    public final boolean zzi;
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MIN_VALUE", mo13011id = 11)
    ...
    @SafeParcelable.Field(defaultValue = "true", mo13011id = 16)
    public final boolean zzo;
    @SafeParcelable.Field(defaultValue = "true", mo13011id = 17)
    ...
    @SafeParcelable.Field(mo13011id = 24)
    public final String zzv;
    @SafeParcelable.Field(defaultValue = "", mo13011id = 25)
    ...
    zzn(@SafeParcelable.Param(mo13014id = 2) String str, @SafeParcelable.Param(mo13014id = 3) String str2, @SafeParcelable.Param(mo13014id = 4) String str3, @SafeParcelable.Param(mo13014id = 5) String str4, @SafeParcelable.Param(mo13014id = 6) long j, @SafeParcelable.Param(mo13014id = 7) long j2, @SafeParcelable.Param(mo13014id = 8) String str5, @SafeParcelable.Param(mo13014id = 9) boolean z, @SafeParcelable.Param(mo13014id = 10) boolean z2, @SafeParcelable.Param(mo13014id = 11) long j3, @SafeParcelable.Param(mo13014id = 12) String str6, @SafeParcelable.Param(mo13014id = 13) long j4, @SafeParcelable.Param(mo13014id = 14) long j5, @SafeParcelable.Param(mo13014id = 15) int i, @SafeParcelable.Param(mo13014id = 16) boolean z3, @SafeParcelable.Param(mo13014id = 17) boolean z4, @SafeParcelable.Param(mo13014id = 18) boolean z5, @SafeParcelable.Param(mo13014id = 19) String str7, @SafeParcelable.Param(mo13014id = 21) Boolean bool, @SafeParcelable.Param(mo13014id = 22) long j6, @SafeParcelable.Param(mo13014id = 23) List<String> list, @SafeParcelable.Param(mo13014id = 24) String str8, @SafeParcelable.Param(mo13014id = 25) String str9) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzj = j3;
