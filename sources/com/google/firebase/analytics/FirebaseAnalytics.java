...
public final class FirebaseAnalytics {
    ...
    /* renamed from: c */
    private static volatile FirebaseAnalytics f18869c;
    /* access modifiers changed from: private */

    /* renamed from: a */
    public final zzag f18870a;

    /* renamed from: b */
    private ExecutorService f18871b;
    ...
    /* renamed from: b */
    private final ExecutorService m11149b() {
        ExecutorService executorService;
        synchronized (FirebaseAnalytics.class) {
            if (this.f18871b == null) {
                this.f18871b = new C3223b(this, 0, 1, 30, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
            }
            executorService = this.f18871b;
        }
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (f18869c == null) {
            synchronized (FirebaseAnalytics.class) {
                if (f18869c == null) {
                    f18869c = new FirebaseAnalytics(zzag.zza(context));
                }
            }
        }
        return f18869c;
    ...
    public static zzib getScionFrontendApiImplementation(Context context, Bundle bundle) {
        ...
        return new C3224c(zza);
    }

    @NonNull
    public final Task<String> getAppInstanceId() {
        try {
            return Tasks.call(m11149b(), new C3222a(this));
        } catch (Exception e) {
            this.f18870a.zza(5, "Failed to schedule task for getAppInstanceId", (Object) null, (Object) null, (Object) null);
    ...
    public final void setAnalyticsCollectionEnabled(boolean z) {
        this.f18870a.zza(Boolean.valueOf(z));
    }
