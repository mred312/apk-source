...
public class CrashlyticsReportJsonTransform {
    ...
    /* renamed from: a */
    private static final DataEncoder f19428a = new JsonDataEncoderBuilder().configureWith(AutoCrashlyticsReportEncoder.CONFIG).ignoreNullValues(true).build();

    /* renamed from: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$a */
    private interface C3423a<T> {
        /* renamed from: a */
        T mo21389a(@NonNull JsonReader jsonReader);
    }

    @NonNull
    /* renamed from: A */
    private static CrashlyticsReport.Session.User m11556A(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: h */
    private static CrashlyticsReport.Session.Application m11564h(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: i */
    private static <T> ImmutableList<T> m11565i(@NonNull JsonReader jsonReader, @NonNull C3423a<T> aVar) {
        ArrayList arrayList = new ArrayList();
        jsonReader.beginArray();
        while (jsonReader.hasNext()) {
            arrayList.add(aVar.mo21389a(jsonReader));
        }
        jsonReader.endArray();
    ...
    @NonNull
    /* renamed from: j */
    public static CrashlyticsReport.CustomAttribute m11566j(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: k */
    private static CrashlyticsReport.Session.Device m11567k(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: l */
    public static CrashlyticsReport.Session.Event m11568l(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setDevice(m11571o(jsonReader));
                    break;
                case 1:
                    builder.setApp(m11569m(jsonReader));
                    break;
                case 2:
                    builder.setLog(m11575s(jsonReader));
                    break;
                case 3:
    ...
    @NonNull
    /* renamed from: m */
    private static CrashlyticsReport.Session.Event.Application m11569m(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    ...
                    break;
                case 1:
                    builder.setExecution(m11572p(jsonReader));
                    break;
                case 2:
                    builder.setCustomAttributes(m11565i(jsonReader, C3426c.m11588b()));
                    break;
                case 3:
    ...
    @NonNull
    /* renamed from: n */
    public static CrashlyticsReport.Session.Event.Application.Execution.BinaryImage m11570n(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: o */
    private static CrashlyticsReport.Session.Event.Device m11571o(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: p */
    private static CrashlyticsReport.Session.Event.Application.Execution m11572p(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setThreads(m11565i(jsonReader, C3427d.m11590b()));
                    break;
                case 1:
                    builder.setSignal(m11576t(jsonReader));
                    break;
                case 2:
                    builder.setBinaries(m11565i(jsonReader, C3428e.m11592b()));
                    break;
                case 3:
                    builder.setException(m11573q(jsonReader));
                    break;
                default:
                    jsonReader.skipValue();
                    break;
    ...
    @NonNull
    /* renamed from: q */
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception m11573q(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(m11565i(jsonReader, C3429f.m11594b()));
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    builder.setCausedBy(m11573q(jsonReader));
                    break;
                case 4:
    ...
    @NonNull
    /* renamed from: r */
    public static CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame m11574r(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: s */
    private static CrashlyticsReport.Session.Event.Log m11575s(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: t */
    private static CrashlyticsReport.Session.Event.Application.Execution.Signal m11576t(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: u */
    public static CrashlyticsReport.Session.Event.Application.Execution.Thread m11577u(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(m11565i(jsonReader, C3430g.m11596b()));
                    break;
                case 1:
                    builder.setName(jsonReader.nextString());
                    break;
    ...
    @NonNull
    /* renamed from: v */
    public static CrashlyticsReport.FilesPayload.File m11578v(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: w */
    private static CrashlyticsReport.FilesPayload m11579w(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("files")) {
                builder.setFiles(m11565i(jsonReader, C3425b.m11586b()));
    ...
    @NonNull
    /* renamed from: x */
    private static CrashlyticsReport.Session.OperatingSystem m11580x(@NonNull JsonReader jsonReader) {
    ...
    @NonNull
    /* renamed from: y */
    private static CrashlyticsReport m11581y(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setNdkPayload(m11579w(jsonReader));
                    break;
                case 1:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    builder.setSession(m11582z(jsonReader));
                    break;
                default:
                    jsonReader.skipValue();
                    break;
    ...
    @NonNull
    /* renamed from: z */
    private static CrashlyticsReport.Session m11582z(@NonNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    builder.setDevice(m11567k(jsonReader));
                    break;
                case 4:
                    builder.setEvents(m11565i(jsonReader, C3424a.m11584b()));
                    break;
                case 5:
                    builder.setOs(m11580x(jsonReader));
                    break;
                case 6:
                    builder.setApp(m11564h(jsonReader));
                    break;
                case 7:
                    builder.setUser(m11556A(jsonReader));
                    break;
                case 8:
    ...
    public com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event eventFromJson(@androidx.annotation.NonNull java.lang.String r3) {
        /*
            r2 = this;
            ...
            com.google.firebase.crashlytics.internal.model.CrashlyticsReport$Session$Event r3 = m11568l(r0)     // Catch:{ all -> 0x0012 }
    ...
    public String eventToJson(@NonNull CrashlyticsReport.Session.Event event) {
        return f19428a.encode(event);
    }

    /* JADX WARNING: Missing exception handler attribute for start block: B:10:0x0016 */
    @androidx.annotation.NonNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.google.firebase.crashlytics.internal.model.CrashlyticsReport reportFromJson(@androidx.annotation.NonNull java.lang.String r3) {
        /*
            r2 = this;
            android.util.JsonReader r0 = new android.util.JsonReader     // Catch:{ IllegalStateException -> 0x0017 }
            java.io.StringReader r1 = new java.io.StringReader     // Catch:{ IllegalStateException -> 0x0017 }
            r1.<init>(r3)     // Catch:{ IllegalStateException -> 0x0017 }
            r0.<init>(r1)     // Catch:{ IllegalStateException -> 0x0017 }
            com.google.firebase.crashlytics.internal.model.CrashlyticsReport r3 = m11581y(r0)     // Catch:{ all -> 0x0012 }
            r0.close()     // Catch:{ IllegalStateException -> 0x0017 }
            return r3
        L_0x0012:
            r3 = move-exception
    ...
    public String reportToJson(@NonNull CrashlyticsReport crashlyticsReport) {
        return f19428a.encode(crashlyticsReport);
    }
}
