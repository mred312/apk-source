...
class C3478b {
    ...
    /* renamed from: a */
    private final FileChannel f19600a;

    /* renamed from: b */
    private final FileLock f19601b;

    private C3478b(FileChannel fileChannel, FileLock fileLock) {
        this.f19600a = fileChannel;
        this.f19601b = fileLock;
    }
    ...
    static com.google.firebase.installations.C3478b m11792a(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
        ...
        L_0x0040:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.C3478b.m11792a(android.content.Context, java.lang.String):com.google.firebase.installations.b");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public void mo21595b() {
        try {
            this.f19601b.release();
            this.f19600a.close();
        } catch (IOException e) {
