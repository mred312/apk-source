...
public class ConfigStorageClient {
    ...
    /* renamed from: c */
    private static final Map<String, ConfigStorageClient> f19711c = new HashMap();
    ...
    public static synchronized ConfigStorageClient getInstance(Context context, String str) {
        ...
        synchronized (ConfigStorageClient.class) {
            Map<String, ConfigStorageClient> map = f19711c;
    ...
    /* renamed from: a */
    public String mo21737a() {
        return this.f19713b;
    }

    public synchronized Void clear() {
        this.f19712a.deleteFile(this.f19713b);
        return null;
    }
    ...
    public synchronized com.google.firebase.remoteconfig.internal.ConfigContainer read() {
        /*
            ...
            monitor-enter(r6)
            r0 = 0
            android.content.Context r1 = r6.f19712a     // Catch:{ FileNotFoundException | JSONException -> 0x0037, all -> 0x002d }
            java.lang.String r2 = r6.f19713b     // Catch:{ FileNotFoundException | JSONException -> 0x0037, all -> 0x002d }
            ...
            com.google.firebase.remoteconfig.internal.ConfigContainer r0 = com.google.firebase.remoteconfig.internal.ConfigContainer.m12103b(r3)     // Catch:{ FileNotFoundException | JSONException -> 0x0038, all -> 0x002b }
    ...
    public synchronized Void write(ConfigContainer configContainer) {
        FileOutputStream openFileOutput = this.f19712a.openFileOutput(this.f19713b, 0);
        try {
            openFileOutput.write(configContainer.toString().getBytes(Key.STRING_CHARSET_NAME));
        } finally {
