...
public class Intent {
    ...
    public static void canOpenIntents(JSONArray jSONArray, WebViewCallback webViewCallback) {
        ...
        while (i < length) {
            ...
            try {
                jSONObject.put(optJSONObject.optString(FacebookAdapter.KEY_ID), checkIntentResolvable(intentFromMetadata(optJSONObject)));
                i++;
            } catch (IntentException e) {
    ...
    private static android.content.Intent intentFromMetadata(JSONObject jSONObject) {
        ...
        String str2 = (String) jSONObject.opt(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME);
