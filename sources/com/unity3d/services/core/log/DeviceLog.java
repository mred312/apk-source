...
public class DeviceLog {
    ...
    static /* synthetic */ class C38921 {
        ...
        static final /* synthetic */ int[] f21048xf32d8d1;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f21048xf32d8d1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f21048xf32d8d1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f21048xf32d8d1     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.log.DeviceLog.C38921.<clinit>():void");
        }
    }
    ...
    private static void write(UnityAdsLogLevel unityAdsLogLevel, String str) {
        boolean z;
        int i = C38921.f21048xf32d8d1[unityAdsLogLevel.ordinal()];
        boolean z2 = true;
        if (i == 1) {
            z = LOG_INFO;
        } else if (i == 2) {
