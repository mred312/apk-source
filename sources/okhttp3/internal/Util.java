...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C3544a();
    public static final TimeZone UTC = TimeZone.getTimeZone("GMT");
    public static final Charset UTF_8 = Charset.forName(Key.STRING_CHARSET_NAME);

    /* renamed from: a */
    private static final ByteString f20017a = ByteString.decodeHex("efbbbf");

    /* renamed from: b */
    private static final ByteString f20018b = ByteString.decodeHex("feff");

    /* renamed from: c */
    private static final ByteString f20019c = ByteString.decodeHex("fffe");

    /* renamed from: d */
    private static final ByteString f20020d = ByteString.decodeHex("0000ffff");

    /* renamed from: e */
    private static final ByteString f20021e = ByteString.decodeHex("ffff0000");

    /* renamed from: f */
    private static final Charset f20022f = Charset.forName("UTF-16BE");

    /* renamed from: g */
    private static final Charset f20023g = Charset.forName("UTF-16LE");

    /* renamed from: h */
    private static final Charset f20024h = Charset.forName("UTF-32BE");

    /* renamed from: i */
    private static final Charset f20025i = Charset.forName("UTF-32LE");

    /* renamed from: j */
    private static final Method f20026j;

    /* renamed from: k */
    private static final Pattern f20027k = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");

    /* renamed from: okhttp3.internal.Util$a */
    class C3544a implements Comparator<String> {
        C3544a() {
        }
    ...
    /* renamed from: okhttp3.internal.Util$b */
    class C3545b implements ThreadFactory {

        /* renamed from: a */
        final /* synthetic */ String f20028a;

        /* renamed from: b */
        final /* synthetic */ boolean f20029b;

        C3545b(String str, boolean z) {
            this.f20028a = str;
            this.f20029b = z;
        }

        public Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.f20028a);
            thread.setDaemon(this.f20029b);
            return thread;
        }
    }
    ...
    /* renamed from: a */
    private static boolean m11993a(String str) {
    ...
    /* renamed from: b */
    private static boolean m11994b(String str, int i, int i2, byte[] bArr, int i3) {
        int i4 = i3;
        while (i < i2) {
            if (i4 == bArr.length) {
                return false;
    ...
    @Nullable
    /* renamed from: c */
    private static InetAddress m11995c(String str, int i, int i2) {
                ...
                if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                    if (i3 != 0) {
                        if (str.regionMatches(i, ":", 0, 1)) {
                            i++;
                        } else if (!str.regionMatches(i, ".", 0, 1) || !m11994b(str, i5, i2, bArr, i3 - 2)) {
                            return null;
                        } else {
                            i3 += 2;
                        }
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(":")) {
            if (!str.startsWith("[") || !str.endsWith("]")) {
                inetAddress = m11995c(str, 0, str.length());
            } else {
                inetAddress = m11995c(str, 1, str.length() - 1);
            }
            if (inetAddress == null) {
                return null;
            }
            ...
            if (address.length == 16) {
                return m11996d(address);
            }
            throw new AssertionError("Invalid IPv6 address: '" + str + "'");
        }
        try {
            String lowerCase = IDN.toASCII(str).toLowerCase(Locale.US);
            if (!lowerCase.isEmpty() && !m11993a(lowerCase)) {
                return lowerCase;
            }
            return null;
    ...
    /* renamed from: d */
    private static String m11996d(byte[] bArr) {
        int i = 0;
        int i2 = -1;
        int i3 = 0;
        int i4 = 0;
    ...
    public static boolean verifyAsIpAddress(String str) {
        return f20027k.matcher(str).matches();
    }
