...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    /* renamed from: a */
    final ByteString[] f21374a;

    /* renamed from: b */
    final int[] f21375b;

    private Options(ByteString[] byteStringArr, int[] iArr) {
        this.f21374a = byteStringArr;
        this.f21375b = iArr;
    }

    /* renamed from: a */
    private static void m14433a(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        int i4;
        int i5;
        Buffer buffer2;
        int i6;
        ...
        if (i8 < i9) {
            ...
            if (byteString.getByte(i7) != byteString2.getByte(i7)) {
                ...
                long b = j + ((long) m14434b(buffer)) + 2 + ((long) (i13 * 2));
                ...
                while (i16 < i9) {
                    ...
                    if (i17 == i5 && i7 + 1 == list3.get(i16).size()) {
                        ...
                        buffer3.writeInt((int) ((((long) m14434b(buffer4)) + b) * -1));
                        i6 = i5;
                        buffer2 = buffer4;
                        m14433a(b, buffer4, i7 + 1, list, i16, i5, list2);
                    }
                    buffer4 = buffer2;
                    i16 = i6;
                }
            ...
            long b4 = 1 + j + ((long) m14434b(buffer)) + 2 + ((long) i19);
            ...
            if (i12 + 1 != i9) {
                ...
                buffer3.writeInt((int) ((((long) m14434b(buffer6)) + b4) * -1));
                m14433a(b4, buffer6, i4, list, i12, i3, list2);
    ...
    /* renamed from: b */
    private static int m14434b(Buffer buffer) {
        return (int) (buffer.size() / 4);
    }

    /* renamed from: of */
    public static Options m14435of(ByteString... byteStringArr) {
        ...
        if (((ByteString) arrayList.get(0)).size() != 0) {
            ...
            m14433a(0, buffer, 0, arrayList, 0, arrayList.size(), arrayList2);
            int b = m14434b(buffer);
            int[] iArr = new int[b];
